    ...
    <section className="hero" aria-labelledby="hero-title">
      <div className="hero__left">
        ...
        <div className="hero__actions">
          <a
            href="https://github.com/raphaelmatori"
            target="_blank"
            rel="noreferrer"
      ...
      <div className="hero__right">
        ...
        <li>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hero__social-link hero__social-link--golden"
            aria-label="GitHub"
          >
            <GitHubIcon />
          </a>
        ...
        <li>
          <a
            href="https://www.linkedin.com/in/raphaelmatori"
            target="_blank"
            rel="noreferrer"
            className="hero__social-link hero__social-link--golden"
            aria-label="LinkedIn"
        ...
        <li>
          <a
            href="mailto:raphaelmatori@hotmail.com"
            className="hero__social-link hero__social-link--golden"
            aria-label="Email"
          >
            <EmailIcon />
